...
plot "perf_rolling_median_shared_memory_ratio.dat" using 1:2 t "Single process" with lines axes x1y1 lw 2, \
     "perf_rolling_median_shared_memory_ratio.dat" using 1:3 t "2 processes" with lines  axes x1y1 lw 2, \
     "perf_rolling_median_shared_memory_ratio.dat" using 1:5 t "4 processes" with lines  axes x1y1 lw 3, \
     "perf_rolling_median_shared_memory_ratio.dat" using 1:9 t "8 processes" with lines  axes x1y1 lw 2, \
     "perf_rolling_median_shared_memory_ratio.dat" using 1:17 t "16 processes" with lines  axes x1y1 lw 2
