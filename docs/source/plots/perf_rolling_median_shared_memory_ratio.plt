...
plot "dat/perf_rolling_median_shared_memory_ratio_cols_16.dat" using 1:2 t "Single process" with lines axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_16.dat" using 1:3 t "2 processes" with linespoints axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_16.dat" using 1:4 t "4 processes" with linespoints axes x1y1 lw 3, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_16.dat" using 1:5 t "8 processes" with linespoints axes x1y1 lw 2, \
...
plot "dat/perf_rolling_median_shared_memory_ratio_cols_1024.dat" using 1:2 t "Single process" with lines axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_1024.dat" using 1:3 t "2 processes" with linespoints  axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_1024.dat" using 1:4 t "4 processes" with linespoints  axes x1y1 lw 3, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_1024.dat" using 1:5 t "8 processes" with linespoints  axes x1y1 lw 2, \
...
plot "dat/perf_rolling_median_shared_memory_ratio_cols_65536.dat" using 1:2 t "Single process" with lines axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_65536.dat" using 1:3 t "2 processes" with linespoints  axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_65536.dat" using 1:4 t "4 processes" with linespoints  axes x1y1 lw 3, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_65536.dat" using 1:5 t "8 processes" with linespoints  axes x1y1 lw 2, \
     "dat/perf_rolling_median_shared_memory_ratio_cols_65536.dat" using 1:6 t "16 processes" with linespoints  axes x1y1 lw 2
